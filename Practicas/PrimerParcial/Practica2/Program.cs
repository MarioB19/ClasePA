using static System.Convert; //importar miembros System.Convert , para poder hacer uso de la funcion: ToBase64String
...
for (int i = 0; i < 128; i++){
    ...
    arr[i] =  (byte)number; //casteo de number a byte , para salvaguardar integridad
}

WriteLine("Binary Object as bytes:");

for (int i = 0; i < 128; i++){
 Console.Write($"{arr[i]:X} "); //Impresion del arreglo en formato hexadecimal , sin necesidad de convertirlo explicitamente
}
